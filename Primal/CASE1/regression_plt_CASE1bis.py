...
beam.SetLoads(19 , 8e-01 , 0 , 16e-02)
...
for i in range(0,beam.nRBE2):
    node_i = int(beam.RBE2_py[i].GetNodes()[0, 0] - 1)
    node_j = int(beam.RBE2_py[i].GetNodes()[1, 0] - 1)
...
for i in range(beam.nPoint):
#    print('{} {}  {}  {} '.format(i, beam.displacement_X[i],beam.displacement_Y[i],beam.displacement_Z[i]) )
    print('{} {}  {}  {} '.format(i, beam.coordinate_X1[i],beam.coordinate_Y1[i],beam.coordinate_Z1[i]) )
